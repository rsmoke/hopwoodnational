...
?>
      <div class="bg-warning infosection">
           ...
           dropdown menu next to each entry, select a ranking value (1 <em>being the best</em>) for that entry. You will only be selecting
           a ranking for the top entries.</p>
